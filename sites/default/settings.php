 ...
 * @endcode
 */
$settings['hash_salt'] = 'rRrKDL0JYQeQueAGdyocYqUHBxEs9od-38LWkRdprG81umVZz-Anazd9RabMzI2ZMkgs6d15yA';
...
$settings['config_sync_directory'] = 'sites/default/files/config_uOx6fk-QGWeXnvOuo0ajvIXvdtEYyJGZZVYA2K_pBt-Po1d2Qm7W2KRQRh7VOIi2WySBpMezpA/sync';
if (file_exists($app_root . '/' . $site_path . '/settings.local.php')) {
  include $app_root . '/' . $site_path . '/settings.local.php';
}